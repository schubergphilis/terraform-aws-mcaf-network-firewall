...
| <a name="input_cloudwatch_logging_configuration"></a> [cloudwatch\_logging\_configuration](#input\_cloudwatch\_logging\_configuration) | Cloudwatch logs configuration | <pre>object({<br>    alert_logs = optional(object({<br>      enabled           = optional(bool, true)<br>      log_group_name    = optional(string, null)<br>      retention_in_days = optional(number, 90)<br>    }), {})<br>    flow_logs = optional(object({<br>      enabled           = optional(bool, true)<br>      log_group_name    = optional(string, null)<br>      retention_in_days = optional(number, 90)<br>    }), {})<br>  })</pre> | `{}` | no |
