output "cloudwatch_log_group_arn" {
  description = "Map of CloudWatch log group type and arn when atleast one log type is enabled"
...
output "cloudwatch_log_group_name" {
  description = "Map of CloudWatch log group type and name when atleast one log type is enabled"
